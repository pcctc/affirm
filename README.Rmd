...
Use `inline_data = TRUE` to create a more compact report with expandable sections showing validation failures inline:
...
```{r, include=FALSE, echo=FALSE}
gt::gtsave(affirm_report_gt(inline_data = TRUE), filename = "man/figures/README-gt-report-inline-data.png")
```
